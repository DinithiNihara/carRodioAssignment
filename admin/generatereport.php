...
<div> <p> Highest Reached Advertisement Report</p>   <a ><input type="button" class="link" value="Generate" name="verify" /> </a> <br> <br>      </div>
<div> <p> Most Engaged Buyer Report</p>    <a><input type="button" value="Generate" class="link" name="manage" /> </a> <br> <br>     </div>
<div> <p> Number Of Advertisements Report </p>   <a> <input type="button" value="Generate" class="link" name="genreport" /> </a> <br> <br>      </div>
<div>         </div>
